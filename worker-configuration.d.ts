/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml` (hash: 399d14e52df81eb38cefe4727348a079)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	AUTH_EMAIL_FROM: "noreply@scorecard.example.com";
	JWT_SECRET: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./pkg/api/server");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_FROM" | "JWT_SECRET">> {}
}
